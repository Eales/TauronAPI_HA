...
class TauronConfigFlow(config_entries.ConfigFlow, domain="tauron_dystrybucja"):
    ...
    if user_input:
        ...
        if len(city_partial) >= 3:
            ...
            if cities:
                ...
                return await self.async_step_city_selection(user_input=None)  # <— poprawka!
    ...
    if user_input:
        ...
        if selected_city == "back":
            return await self.async_step_user(user_input=None)  # <— poprawka!
        if selected_city in self.city_choices:
            self.selected_city = selected_city
            return await self.async_step_street(user_input=None)  # <— poprawka!
    ...
    if user_input:
        ...
        if len(street_partial) >= 3:
            ...
            if streets:
                ...
                return await self.async_step_street_selection(user_input=None)  # <— poprawka!
    ...
    if user_input:
        ...
        if selected_street in self.street_choices:
            ...
            return await self.async_step_house_number(user_input=None)  # <— poprawka!
